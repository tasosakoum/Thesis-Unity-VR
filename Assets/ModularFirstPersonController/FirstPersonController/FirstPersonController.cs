...
public class FirstPersonController : MonoBehaviour
{
    ...
    public float objectMaxDistanceFromCamera = 2f;

    private Interactable currentlyHeldObject;
    ...
    void Start()
    {
        holdPoint = new GameObject("Hold Point");
        holdPoint.transform.SetParent(playerCamera.transform);
        holdPoint.transform.localPosition = new Vector3(0, 0, 2);
    ...
    private void Update()
    {
        ...
        if (Input.GetMouseButtonUp(0) && currentlyHeldObject != null) {
    ...
    private void CastRay() {
        ...
        if (Physics.Raycast(ray, out hit, rayCastRange)) {
            ...
            if (interactable != null) {
                ...
                interactable.OnPickUp(holdPoint.transform);
            } else {
